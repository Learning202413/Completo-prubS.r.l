...
const ROUTES = {
    ...
    'produccion': {
        html: 'js/views/produccion.html',
        controller: ProductionController
    },
    'historial-global': {
        html: 'js/views/historial-global.html',
        controller: HistorialGlobalController
    },
    'historial-orden': {
        html: 'js/views/historial-orden.html',
        controller: HistorialOrdenController
    },
    'usuarios': {
        html: 'js/views/usuarios.html',
        controller: UsuariosController
    },
    'proveedores': {
        html: 'js/views/proveedores.html',
