 ...
 * Lógica para renderizar la barra lateral de navegación de Post-Prensa.
 */

// Define la navegación específica del módulo
const NAV_LINKS = [
    { id: 'cola', name: 'Cola de Acabados', icon: 'list-todo', href: 'cola' }
];
    ...
    menuContainer.innerHTML = `
        <div class="flex flex-col h-full w-64">
            <div class="py-6 px-4 flex items-center justify-center nav-sidebar-bg/90 shadow-lg">
                <!-- Logo ajustado a h-20 (80px), ocupando más espacio vertical y horizontal -->
            ...
            <div class="mt-auto p-4 border-t border-gray-700">
                <button id="logout-button" class="nav-link flex items-center w-full px-4 py-3 rounded-lg text-sm font-medium text-gray-200 hover:bg-red-800 hover:text-white">
