 ...
 * ACTUALIZADO: Soporte para Precio, Edición, Eliminación y LOGS.
 */
...
// Datos semilla actualizados con PRECIO
const SEED_ITEMS = [
...
export const StockService = {
    ...
    async updateProduct(originalSku, updates) {
        ...
        // Mantener el SKU original, actualizar el resto
    ...
    async deleteProduct(sku) {
        ...
        const product = items.find(i => i.sku === sku); // Guardar referencia para el log
    ...
    async createOC(ocData) {
        ...
        // Nota: La creación de OC podría auditarse también, pero por ahora se pidió la RECEPCIÓN.
