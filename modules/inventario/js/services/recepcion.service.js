 ...
 * CORRECCIÓN: Asegura que el stock se sume matemáticamente y no se concatene como texto.
 */
    ...
    async receiveOC(ocId, itemsReceived, comentarios) {
        ...
        itemsReceived.forEach(recItem => {
            ...
            if (prodIndex !== -1) {
                ...
                console.log(`[Stock Update] ${recItem.producto}: ${currentStock} + ${receivedQty} = ${products[prodIndex].stock}`);
            }
        });
